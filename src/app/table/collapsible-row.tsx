...
export const CollapsibleRow: React.FC<CollapsibleRowProps<any>> = ({ row }) => {
                    ...
                    <motion.tr
                        ...
                        {row
                            ...
                            .map((_, index) => (
                                <td
                                    key={`empty-${index}`}
                                    className="p-0 sticky left-10 top-8 first:left-0 z-20 bg-background"></td>
                            ))}

                        <td
                            className="max-w-[100vw] py-2 pr-3 pl-0"
                            colSpan={
                            ...
                            <SubTable
                                columns={columns}
                                data={row.original.origin_items}
                            />
                        </td>
                    </motion.tr>
                </CollapsibleContent>
